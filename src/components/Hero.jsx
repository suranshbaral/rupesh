			...
			>
				...
				<div>
					<h1 className={`${styles.heroHeadText} text-white relative z-10`}>
						Hi, I'm <span className='text-clr_blue'>Rupesh</span>
					</h1>
					<p
						className={`${styles.heroSubText} relative z-10 mt-2 text-white-100 md:max-w-[640px] max-w-[460px] `}
					>
						Results-driven Financial Specialist with 8+ years' experience in data analysis, budget forecasting, and leading teams for successful sales strategies.
					</p>
				</div>
			</div>
