...
const Navbar = () => {
  ...
  return (
    <nav className={`w-full  flex items-center mx-auto fixed  bg-transparent transp-gradient  top-0 left-1/2 -translate-x-1/2 z-20`}>
      <div className={`${styles.paddingX} w-full max-w-7xl flex justify-between items-center sm:py-5 py-4 mx-auto`}>
        <Link to='/' className='flex items-center gap-2' onClick={() => { setActive(''); window.scrollTo(0, 0); }}>
          ...
          <p className='flex text-white text-[18px] font-bold cursor-pointer hover:text-primary'>
            Rupesh &ensp;<span className='sm:block hidden'>Baral</span>
          </p>
        </Link>
